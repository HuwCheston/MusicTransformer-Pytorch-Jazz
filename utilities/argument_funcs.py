...
def parse_train_args():
    ...
    parser.add_argument("-input_dir", type=str, default="./dataset", help="Folder of preprocessed and pickled midi files")
    ...
    parser.add_argument("-batch_size", type=int, default=25, help="Batch size to use")
